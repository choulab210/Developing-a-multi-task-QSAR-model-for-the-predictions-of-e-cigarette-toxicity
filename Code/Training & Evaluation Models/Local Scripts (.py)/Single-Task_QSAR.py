...
# ============================================================================
target_columns = ['Genotoxicity'] # Change to Desired Task
...
print('-------------------------------------------------------------')
CheckData(Y1_test, 'Genotoxicity')# Change to Desired Task
#%% ============================================================================
...
with torch.no_grad():
    ...
    train_pred_probs = [output.squeeze().numpy() for output in train_outputs]  # Single-task still outputs a list
